...
<div class="container-fluid">
    <div class="row row-centered">
        <div class="col-lg-4 col-md-4 col-sm-10 col-centered translucent-background">
            ...
            <%if(request.getParameter("actiontype").equals("datebydate")) {
                ...
                String query="SELECT D.Date_Time, D.Profile1, D.Profile2, D.Location, P.FirstName AS "+
                        ...
                        "WHERE D.Date_Time >= '"+request.getAttribute("datetime")+" 00:00:00' AND D.Date_Time <= '"+request.getAttribute("datetime")+" 23:59:59' AND D.CustRep = P.SSN;" ;
